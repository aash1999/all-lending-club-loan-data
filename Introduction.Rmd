...
author: "Emma Gantulga, Ayush Meshram, Aakash Singh, and Melissa Yago"
date: "10/20/24"
output:
  html_document:
    code_folding: show
...
Since 2006, LendingClub has been a U.S. financial services company that has facilitated loan contracts. Our research will focus on LendingClub's loan data that consist of approved and rejected loans between 2013-2018. To understand LendingClub's clientele, we will analyzie borrower characteristics to assess risk levels, determine loan acceptance, and predict whether accepted loans will be fully repaid.To accomplish this, we will ask the following SMART questions:
