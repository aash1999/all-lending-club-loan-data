...
# Call the function
results <- train_and_evaluate_rf(train_df, eval_df, target_column, ntree=120, maxdepth = 25, maxnodes = 20, classwt = c("Charged Off" = chareoff_class_wt, "Fully Paid" = fully_paid_class_wt))
