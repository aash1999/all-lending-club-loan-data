...
# Assuming your target column is binary (e.g., "Charged Off" vs "Fully Paid")
# and test_df is your test dataset
predictions <- predict(final_results$model, test_df, type = "prob")

# Extract the probabilities for the positive class (e.g., "Charged Off")
positive_class_prob <- predictions[, "Charged Off"]

# Extract the true labels from the test dataset
true_labels <- test_df$target_col  # Replace `target_col` with the actual column name
