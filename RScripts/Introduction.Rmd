...
output:
  html_document:
    ...
    toc_depth: 3
    toc_float: true
    theme: "flatly"  # You can change this to another theme if preferred
    css: "./styles.css"
  pdf_document:
    toc: true
    toc_depth: 3
header-includes:
  ...
  - \setlength{\headheight}{50pt}  # Adjusts header height for graphics
---


```{r include-banner, echo=FALSE, out.width='100%'}
knitr::include_graphics("../gwu_banner.png")  # Replace with your banner's file path
```
...
- **Count**: The dataset contains approximately `r nrow(df)` approved loans.
- **Structure**: The dataset has `r ncol(df)` variables capturing various aspects of each loan and borrower profile, such as credit score, loan amount, employment length, and loan status.
...
- **Count**: The rejected loan dataset contains around `r nrow(dfr)` rejected applications.
- **Structure**: This dataset includes `r ncol(dfr)` variables, focusing on key aspects like the applicant's risk score, debt-to-income ratio, and application date.
...
## Analysis of Charged-Off Loan Percentage (2013-2018)
...
## Hypothesis Testing for Key Financial Features
...
## Analysis of Charged-Off Loans by State
...
## Comparison of Debt-to-Income Ratios: Charged-Off vs. Fully Paid Loans (2013-2018)
...
## Radar Chart Analysis of Loan Characteristics (2014 vs. 2018)
...
## Contour Plot Comparing Risk Score vs. Debt-to-Income Ratio Before and After 2015
...
## Histogram Analysis of Debt-to-Income Ratios (DTI) for Rejected Loans
...
## Repayment Rate by Grade and Income Bracket 
...
## Chi Square Test Grade Vs Loan Status
...
## Analysis of Employment length and loan amount
...
## Boxplot for Outlier-Exempted Data in Analyzing Employment Length and Amount Requested for the Rejected Loans Dataset
...
## Rejected loan analysis: Employment length and Amount requested VS DTI risk score
